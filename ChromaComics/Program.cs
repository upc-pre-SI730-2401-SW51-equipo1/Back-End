...
using ChromaComics.Shared.Interfaces.ASP.Configuration;
...
builder.Services.AddSwaggerGen(
    c =>
    {
        c.SwaggerDoc("v1",
            new OpenApiInfo
            {
                Title = "ChromaComics.Platform.API",
                Version = "v1",
                Description = "ChromaComics Platform API",
                TermsOfService = new Uri("https://chromacomics-platform.com/tos"),
                Contact = new OpenApiContact
                {
                    Name = "Chroma Comics",
                    Email = "contact@chromacomics.com"
                },
